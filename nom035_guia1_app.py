...
GUIDE3_QUESTIONS = [
    ...
    {"id": "g3_q20", "text": "Se fomentan la confianza entre empleados.", "type": "likert"},
                ...
                if st.button(t["submit"], key="submit_guide2"):
                    if action_lock():
                        try:
                            ...
                            st.error(f"{t['unknown_error'].format(error='Guide 2 submission failed')} {t['debug_prompt']}" if DEBUG_MODE else t["unexpected_error"].format(error="Guide 2 submission failed"))
